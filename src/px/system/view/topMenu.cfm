<div id="menuDiv" class="navbar bg-dark px-no-radius" ng-controller="pxTopMenuCtrl">
    <cfinvoke component="px-project.src.px.system.model.menu" method="getMenu" returnvariable="pxMenu">
